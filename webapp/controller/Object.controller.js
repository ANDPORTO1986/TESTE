sap.ui.define([
    ...
    return BaseController.extend("bpanderson01.controller.Object", {
        ...
        onSavePress: function () {
            ...
            oModel.update("/PARCEIROSet('" + oJson.PartnerId + "')", oJson, {
                success: (oData) => {
        ...
        _onObjectMatched : function (oEvent) {
            ...
            this._bindView("/PARCEIROSet" + sObjectId);
        },
        ...
        _onBindingChange : function () {
            ...
            var oResourceBundle = this.getResourceBundle(),
                ...
                sObjectName = oObject.PARCEIROSet;
