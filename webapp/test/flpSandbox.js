		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "titulo d ",
									"targetURL": "#bpanderson01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpanderson01-display": {
								"semanticObject": "bpanderson01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpanderson01",
									"url": sap.ui.require.toUrl("bpanderson01")
								}
							}
						}
					}
